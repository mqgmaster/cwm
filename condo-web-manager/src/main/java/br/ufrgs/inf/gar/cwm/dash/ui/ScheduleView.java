...
import br.ufrgs.inf.gar.cwm.dash.component.AptDetailsWindow;
...
public final class ScheduleView extends CssLayout implements View {
    ...
    private void injectMovieCoverStyles() {
        ...
        String styles = "";
        for (Apt m : DashboardUI.getDataProvider().getMovies()) {
    ...
    private Component buildCalendarView() {
        ...
        calendar.setHandler(new EventClickHandler() {
            ...
            public void eventClick(final EventClick event) {
                ...
                AptDetailsWindow.open(movieEvent.getMovie(),
    ...
    private Component buildCatalogView() {
        ...
        for (final Apt movie : DashboardUI.getDataProvider().getMovies()) {
            ...
            frame.addLayoutClickListener(new LayoutClickListener() {
                ...
                public void layoutClick(final LayoutClickEvent event) {
                    if (event.getButton() == MouseButton.LEFT) {
                        AptDetailsWindow.open(movie, null, null);
                    }
                }
            });
    ...
    private class MovieEventProvider implements CalendarEventProvider {
        ...
        public List<CalendarEvent> getEvents(final Date startDate,
            ...
            for (Transaction transaction : transactions) {
                Apt movie = DashboardUI.getDataProvider().getMovie(
    ...
    public final class MovieEvent implements CalendarEvent {
        ...
        public MovieEvent(final Date start, final Date end, final Apt movie) {
            this.start = start;
            this.end = end;
            this.movie = movie;
        }
        ...
        public void setMovie(final Apt movie) {
            this.movie = movie;
        }
