...
import br.ufrgs.inf.gar.cwm.dash.component.InlineTextEditor;
import br.ufrgs.inf.gar.cwm.dash.component.TopSixCondosChart;
import br.ufrgs.inf.gar.cwm.dash.component.TopTenAptsTable;
import br.ufrgs.inf.gar.cwm.dash.component.TransactionsListing;
    ...
    public final class SortableLayout extends CustomComponent {
        ...
        private Component createComponentFromPaletteItem(
            ...
            if (type == PaletteItemType.TEXT) {
                ...
                result = new TopTenAptsTable();
            } else if (type == PaletteItemType.CHART) {
                result = new TopSixCondosChart();
