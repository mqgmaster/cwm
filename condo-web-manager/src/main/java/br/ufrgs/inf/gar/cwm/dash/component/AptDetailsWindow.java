...
public final class AptDetailsWindow extends Window {

    private final Label synopsis = new Label();

    private AptDetailsWindow(final Apt movie, final Date startTime,
            final Date endTime) {
    ...
    private Component buildMovieDetails(final Apt movie,
    ...
    private Component buildDetailsForm(final Apt movie, final Date startTime,
            final Date endTime) {
    ...
    private void updateSynopsis(final Apt m, final boolean expand) {
    ...
    public static void open(final Apt movie, final Date startTime,
            final Date endTime) {
        DashboardEventBus.post(new CloseOpenWindowsEvent());
        Window w = new AptDetailsWindow(movie, startTime, endTime);
