...
public class ApartmentInstrument implements InstrumentHandlerInterface{

	protected Integer apCount = new Integer(1);
	...
	*/
	public Hashtable getAttributes() throws Exception { 
		...
		toReturn.put(new Integer(APCOUNT),getApCount());
		return toReturn;
	}
	...
	*/
	...
	/**
	 * Handles the SNMP Get Request for apCount
	 */
	...
	/**
	 * Handles the SNMP Set Request for apCount
	 * @param value - The Integer value to be set
	 */
	public synchronized void setApCount(Integer value){
		// Fill up the stub with required processing
