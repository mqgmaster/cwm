...
public class EmployeeInstrument implements InstrumentHandlerInterface{

	protected Integer epCount = new Integer(1);
	...
	*/
	public Hashtable getAttributes() throws Exception { 
		...
		toReturn.put(new Integer(EPCOUNT),getEpCount());
		return toReturn;
	}
	...
	*/
	...
	/**
	 * Handles the SNMP Get Request for epCount
	 */
	...
	/**
	 * Handles the SNMP Set Request for epCount
	 * @param value - The Integer value to be set
	 */
	public synchronized void setEpCount(Integer value){
		// Fill up the stub with required processing
